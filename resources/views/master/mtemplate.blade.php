...
@section('content')
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                <h5>Email Templates Management</h5>
            </div>
    ...
    <script>
        ...
        $(document).on("click", ".btn-activate", function () {
            ...
            $('#actionForm').attr('action', '{{url('/mtemplate/toggle')}}');
            $('#actionForm').submit();
        });
        @if($update=='X')
        $(document).on("click", ".btn-edit", function () {
            var userid = $(this).attr('userid');
            window.location.href = '/mtemplate/edit/' + userid;
        });
        @endif
        ...
        $(document).on("click", "#actDelete", function () {
            ...
            if (ids != "") {
                $('#state_param').val(2);
                $('#userid_param').val(ids);
                $('#actionForm').attr('action', '{{url('/mtemplate/destroy')}}');
